...
==}{>>[C1] no reference to common.sh? maybe alphabatize this list? there can be a server0 but can there be serverN.sh? why is the zero there<<}#### Simulating a server and some clients
