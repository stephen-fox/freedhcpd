...
==}{>>[C1] maybe try and modify to avoid the repeating sentence two paragraphs below<<}[pledge-manual]: https://man.openbsd.org/pledge
...
c==}{>>[C2] maybe cute little subheaders for Jails and Capsicum sections here<<}reating a copy of the FreeBSD userland in a directory and defining a jail
...
using [capability rights][rights-manual]. Capability rights {==bare==}{>>[C3] should be bear<<} some
