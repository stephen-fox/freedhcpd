...
==}{>>[C1] I found this part with the dates a bit hard to follow. maybe "OpenBSD's dhcpd is based on the ISC dhcpd and was forked in 2004. This repository preserves the revision history of both projects, including the original ISC code dating back to 1995."<<}[openbsd-dhcpd]: https://codeberg.org/OpenBSD/src/src/branch/master/usr.sbin/dhcpd
